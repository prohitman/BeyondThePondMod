...
public class BoPSmoothSwimmingMoveControl extends MoveControl {
    ...
    public BoPSmoothSwimmingMoveControl(BoPDolphin pMob, int pMaxTurnX, int pMaxTurnY, float pInWaterSpeedModifier, float pOutsideWaterSpeedModifier, boolean pApplyGravity) {
        super(pMob);
