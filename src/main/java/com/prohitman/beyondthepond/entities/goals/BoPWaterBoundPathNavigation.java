...
public class BoPWaterBoundPathNavigation extends PathNavigation {
    public boolean canMove = false;
    public BoPWaterBoundPathNavigation(Mob pMob, Level pLevel) {
        super(pMob, pLevel);
        if(pMob.getType() == ModEntities.ORCA.get() || pMob.getType() == ModEntities.HUMPBACK_WHALE.get()){
            this.canMove = true;
        }
    }
